...
tables.test_points = osm2pgsql.define_node_table('test_points', {
    { column = 'tags', type = 'jsonb' },
    { column = 'geom', type = 'point', projection = srid },
},{ schema = 'osm' })

tables.test_lines = osm2pgsql.define_way_table('test_lines', {
    { column = 'tags', type = 'jsonb' },
    { column = 'geom', type = 'linestring', projection = srid },
},{ schema = 'osm' })

tables.test_polygons = osm2pgsql.define_area_table('test_polygons', {
    { column = 'tags', type = 'jsonb' },
    { column = 'geom', type = 'geometry', projection = srid },
    { column = 'area', type = 'area' },
},{ schema = 'osm' })

tables.test_routes = osm2pgsql.define_relation_table('test_routes', {
    { column = 'tags', type = 'jsonb' },
    { column = 'geom', type = 'multilinestring', projection = srid },
},{ schema = 'osm' })

tables.test_boundaries = osm2pgsql.define_relation_table('test_boundaries', {
    { column = 'tags', type = 'jsonb' },
    { column = 'geom', type = 'multilinestring', projection = srid },
},{ schema = 'osm' })
...
function osm2pgsql.process_way(object)
    ...
    if object.is_closed and has_area_tags(object.tags) then
        tables.test_polygons:add_row({
            tags = object.tags,
            geom = { create = 'area' }
        })
    else
        tables.test_lines:add_row({
            tags = object.tags
        })
    end
end
...
function osm2pgsql.process_relation(object)
    ...
    if type == 'boundary' or (type == 'multipolygon' and object.tags.boundary) then
        tables.test_boundaries:add_row({
            tags = object.tags,
            geom = { create = 'line' }
        })
        return
