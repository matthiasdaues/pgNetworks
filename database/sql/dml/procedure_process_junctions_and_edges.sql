...
create or replace procedure pgnetworks_staging.process_junctions_and_edges(lower_bound bigint, upper_bound bigint)
language plpgsql
as $procedure$
--do $$
declare
...
drop procedure pgnetworks_staging.process_junctions_and_edges(bigint, bigint);